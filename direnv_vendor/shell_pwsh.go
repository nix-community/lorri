...
if ($PSVersionTable.PSVersion.Major -lt 7 -or ($PSVersionTable.PSVersion.Major -eq 7 -and $PSVersionTable.PSVersion.Minor -lt 2)) {
    throw "lorri: PowerShell version $($PSVersionTable.PSVersion) does not meet the minimum required version 7.2!"
}
...
/*
   ...
   Newline or carriage return characters in any part of the output of `lorri export pwsh`
   ...
   `(lorri export pwsh) -join [Environment]::NewLine`
